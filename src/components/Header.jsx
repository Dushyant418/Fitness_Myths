        ...
        <section className='hero_baground'>
            ...
            <div className=' container max_width_1140'>
                <div className='row  padding_top_110 pt-5 pt-lg-0 padding_bottom_96'>
                    <div className='col-12 col-lg-7 d-flex align-items-end  justify-content-center justify-content-lg-start'>
                        <h2
                            className='text-white m-0 fw-bold font_size_xxl font_family_Eurostile_Extended line_height_2xl max_width_640 pb-4 pb-lg-0'>
