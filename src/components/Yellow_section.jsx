                ...
                <div className='row flex-column-reverse flex-lg-row pt-5 pb-5'>
                    <div className='col-12 col-lg-8 d-flex align-items-center justify-content-center justify-content-lg-start'>
                        <div className=' max_width_704'>
                            <h2 className='fw-bold text-black font_size_xl line_height_xxl mb-0 font_family_Eurostile_Extended text-capitalize'>With the right knowledge maintaining and improving your fitness becomes effortless and enjoyable. Stop wasting time you don’t have!</h2>
                        </div>
                    </div>
                    <div className='col-12 col-lg-4 d-flex justify-content-center pb-4 pb-lg-0'>
